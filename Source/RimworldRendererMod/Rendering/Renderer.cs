...
namespace RimworldRendererMod.Rendering
{
    ...
    //    private FrameInfo ScaleToFit(int width, int height, int containerWidth, int containerHeight)
    //    {
    //        int fw = 0;
    //        int fh = 0;
    //        int ox = 0;
    ...
    //        return new FrameInfo() { Width = fw, Height = fh, OffsetX = ox, OffsetY = oy };
